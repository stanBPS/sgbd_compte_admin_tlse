...
public class Modif_panel extends JPanel{
	...
	public Modif_panel() {
		...
		button_modif = new JButton("MODIFIER");
		button_modif.setBounds(500,467,287,137);
					...
					if (option == 0){
					    ...
					    if(mdp.equals("1234")) {
					    	if((!id.getText().isEmpty()) && entiteFinanciere.getSelectedIndex() != -1 &&  d_r.getSelectedIndex() != -1 &&  i_f.getSelectedIndex() != -1 &&  codeChapitre.getSelectedIndex() != -1 && codeArticle.getSelectedIndex() != -1 &&   codePresentation.getSelectedIndex() != -1 && o_r.getSelectedIndex() != -1 && !montant.getText().isEmpty()) {
					    		d.UpdateEnrDatabase((Integer.valueOf(id.getText())),(String)(entiteFinanciere.getSelectedItem()), (String)(d_r.getSelectedItem()), (String)(i_f.getSelectedItem()), (int) (codeChapitre.getSelectedItem()), (int) (codeArticle.getSelectedItem()),(int) (codePresentation.getSelectedItem()),(String) o_r.getSelectedItem(), Float.valueOf(montant.getText()));	    
					    	}else {
						    	JOptionPane.showMessageDialog(null, "Mise à jour impossible remplisser toute les cases","Message d'erreur",JOptionPane.ERROR_MESSAGE);
						    }
					    }else {
